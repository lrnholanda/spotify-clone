import {Home as HomeIcon, Search, Library, ChevronLeft, ChevronRight, Play, Shuffle, SkipBack, SkipForward, Repeat2, Repeat, Mic2, LayoutList, LucideAlarmPlus, Laptop2, Volume, Maximize, Maximize2} from 'lucide-react'
    ...
    return (
        ...
        <div className='flex flex-col items-center gap-2'>
           ...
           <div className='flex items-center gap-2'>
            ...
            <span className='text-xs text-zinc-500'>5:06</span>
           </div>
        </div>
        <div className='flex items-center gap-2'>
           <Mic2 size={20}/>
